 ...
 */
export function maybeScheduleSync() {
    try {
        const dataDir = getDataDir();
        const intervalMin = Number(process.env.MEMORY_SYNC_INTERVAL_MIN ?? DEFAULT_SYNC_INTERVAL_MIN);
        ...
        if (Date.now() - last < intervalMin * 60_000)
            return;
