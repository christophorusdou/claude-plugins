---
name: memory
description: Cross-project memory system — store, recall, and manage persistent memories with semantic search and voting
---
...
1. Call `memory_recall` with a natural language query
